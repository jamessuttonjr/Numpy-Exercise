...
print("-----------------------------------------------   STEP FOUR   -----------------------------------------------")
print("Total Sales for each register: ", salesArray.sum(axis = 1))
print()
...
print("-----------------------------------------------   STEP NINE  -----------------------------------------------")
print("Updated Register 3 Fourth Sale: ")
print()
print(salesArray)
print()
